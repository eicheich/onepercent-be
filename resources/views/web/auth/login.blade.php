...
<head>
    ...
    <title>OnePercent - Sign In</title>
...
<body class="bg-gray-50 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            <form method="POST" action="{{ route('web.login.post') }}" class="space-y-4">
                @csrf
                <div>
          ...
          hover:bg-gray-50 transition">
            ...
            <p class="text-center text-sm text-gray-500 mt-6">
                ...
                <a href="{{ route('web.register') }}" class="text-primary font-semibold hover:text-primary-dark">
                    Sign Up
                </a>
            </p>
        </div>
        ...
        <p class="text-center text-xs text-gray-400 mt-4">
            <a href="{{ route('landing') }}" class="hover:text-gray-600">← Back to home</a>
        </p>
    </div>
</body>
